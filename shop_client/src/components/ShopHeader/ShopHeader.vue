<template>
  <div class="shop-header">
    ...
    <div class="shop-content" @click="isShowShopBrief = !isShowShopBrief">
      <img
        class="content-image"
        :src="info.avatar"
      />
    ...
    <div class="shop-header-discounts" v-if="info.supports" @click="isShowActivitys = !isShowActivitys">
      <div class="discounts-left">
        <div class="activity " :class="supportsType[info.supports[0].type]">
            <span class="content-tag">
    ...
    <transition name="fade">
      <div class="shop-brief-modal" v-show="isShowShopBrief" >
        <div class="brief-modal-content">
          ...
          <div class="mask-footer" @click="closeShopBrief">
    ...
    <transition name="fade">
      <div class="activity-sheet" v-show="isShowActivitys" >
        <div class="activity-sheet-content">
          <h2 class="activity-sheet-title">优惠活动</h2>
          <ul class="list">
            <li class="activity-item " :class="supportsType[support.type]" v-for="(support,index) in info.supports" :key="index">
              <span class="content-tag">
          ...
          <div class="activity-sheet-close" @click="closeactivity">
            <span class="iconfont icontubiaozhizuomoban-"></span>
          </div>
        </div>
...
export default {
  ...
  data(){
    return {
      supportsType : ['activity-green','activity-red','activity-orange'],
      isShowShopBrief : false,
      isShowActivitys : false
  ...
  methods : {
    closeShopBrief(){
      this.isShowShopBrief = !this.isShowShopBrief
    },
    closeactivity(){
      this.isShowActivitys = !this.isShowActivitys
    }
  }
}
</script>
